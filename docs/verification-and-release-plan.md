...
- exactly three pages with no overflow/clipping;
...
8. Pocket Card and PWA artifact storage/release packaging decisions; the Field Guide PDF is a source-controlled generated release artifact as of Phase 2.
