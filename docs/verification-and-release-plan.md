...
This plan defines the future evidence required to move the Companion from design through a tagged field release. It is not an implementation and does not authorize publication or deployment.
...
- fixed US Letter page geometry;
- approximately three pages with no overflow/clipping;
...
8. Whether PDF is a release artifact or only a locally generated derivative.
