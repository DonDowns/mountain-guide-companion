...
console.log('transaction_model_test=pass');
console.log('transaction_model_failed_candidate_cases=5');
console.log('transaction_model_quota_case_preserves_previous=pass');
console.log('transaction_model_completion_marker_order=pass');
